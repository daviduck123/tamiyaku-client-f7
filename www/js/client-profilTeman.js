				...
				$.ajax({ 
					...
					if(id_teman != getData("active_user_id"))
					{
						...
						if(statusTeman==1)
						{
							...
							html += 		'<tr>';
							html += 			'<td rowspan="4">';
							html += 				'<img class="lazy" src="data:image/jpeg;base64,'+foto+'" style="max-width:100px;max-height: 100px; height: 100%;">';
					...
					else
					{
						...
						var html=	'<input type="hidden" id="id_teman_temp" value="'+id+'">';
							...
							html += 		'<tr>';
							html += 			'<td rowspan="4">';
							html += 				'<img class="lazy" src="data:image/jpeg;base64,'+foto+'" style="max-width:100px;max-height: 100px; margin-right:10px; height: 100%;">';
							html += 			'</td>';
							html +=				'<td style="font-weight:bold;"><center>'+banyakPost+'</center></td>';
							html +=				'<td style="font-weight:bold;"><center>'+banyakTeman+'</center></td>';
							html += 	'	</tr>';
